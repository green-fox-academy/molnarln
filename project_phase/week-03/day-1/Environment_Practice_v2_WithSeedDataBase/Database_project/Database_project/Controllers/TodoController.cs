...
namespace Database_project.Controllers
{
    ...
    public class TodoController : Controller
    {
        ...
        [HttpPost("createSeedData")]
        public IActionResult CreateSeedData([FromBody]User userToAdd)
        {
            User user = new User() {admin=false, badges=null, name = "TestName", tokenAuth = "adsfadf", pic = "asdfadsf" };
            applicationContext.Users.Add(user);
            applicationContext.SaveChanges();
            return Created("user has been added", userToAdd);
        }
